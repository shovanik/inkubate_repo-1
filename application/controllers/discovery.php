  ...
  public function index(){
   ...
   public function index2(){
    ...
    public function ajax_global_search()
    {
		...
		$data['keyword'] = $this->input->post("search_val");
        $data['status'] = '0';
        //echo $data['keyword'];die;
		$this->load->view('discovery/ajax_discovery',$data);
		
    	}
    }
    
    public function ajax_discovery_global_search(){
    if($this->session->userdata('logged_user')){
        ...
        $data['keyword'] = $this->input->post('str');
...
public function user_details()
{
    if($this->session->userdata('logged_user')){
        ...
        $this->load->view('profile/userDetails',$data);
   }
    else{
        redirect('home/login', 'refresh');
    } 
