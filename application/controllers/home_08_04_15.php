	   ...
	   if($this->session->userdata('logged_user')){
          ...
          if($usd['user_type'] == '2'){
           ...
           //Latest Pitchit Portion Start//
            ...
            $data['offset_saved']   = $offset_all;
            $data['page_saved']     = $page_all;
            $data['userAllPitchitDetails']    = $this->mpitchit->getUserAllPitchitDetails($offset_all,$limit_all);
            //View All pitchits portion//
            ...
            $data['pitchit_details_limit_total'] = array_merge( $data['pitchit_details_limit_form'], $data['pitchit_details_limit_cat'] );
            $data['pitchit_details_limit_original'] = array_slice ($data['pitchit_details_limit_total'],0,5);
