    ...
    public function publisher()
	{
	   if($this->session->userdata('logged_user')){
          ...
          if($usd['user_type'] == '2'){
           ...
           if(!empty($user_bio['interested_title'])) { $val=$val+1; }
           if(!empty($user_bio['offer_ebook'])) { $val=$val+1; }
           if(!empty($user_bio['title_publish'])) { $val=$val+1; }
