   ...
   public function __construct()
    {
        ...
        $this->load->model(array('mhome','memail','mprofile','mwork','mbookshelf','mfeeds','mnews'));
    ...
    public function publisher()
	{
	   if($this->session->userdata('logged_user')){
          ...
          if($usd['user_type'] == '2'){
           ...
           $data['pitchit_details_limit_original'] = array_slice ($data['pitchit_details_limit_total'],0,3);
           ...
           //saved pitchits portion//
            ...
            $data['user_pitchit_details']  = $this->memail->get_user_pitchit_details_publisher($offset_saved,$limit_saved);
...
public function delete_folder_msg(){
    ...
    public function folder()
    {
        if($this->session->userdata('logged_user')){
            ...
            $data['title']              = $this->memail->getFolderName($this->uri->segment(3));
