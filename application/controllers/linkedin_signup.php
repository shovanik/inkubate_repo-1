...
exit; */
       ...
       $twit_user_email = $this->mhome->get_twit_user_byemail($user->emailAddress);
             ...
             //echo 'hi'.$twit_user_email['user_type'];die;
             ...
             //echo 'hi'.$twit_user['password'].'hello';die;
                 ...
                 elseif($twit_user_email['user_type'] == '2')
                 {
                    if($this->session->userdata('logged_user')){
                    $usd = $this->session->userdata('logged_user');
                 ...
                 elseif($twit_user_email['user_type'] == '3')
                 {
                    ...
                    //echo 'hi'.$twit_user_email['count'];die;
