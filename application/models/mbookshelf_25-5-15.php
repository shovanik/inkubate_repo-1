...
class mbookshelf extends CI_Model
{
  ...
  function get_user($uid){
    ...
    public function BookShelves_share(){
        ...
        $row=$this->db->select('id')->where('email',$email)->get('users')->row_array();
        
          $data22['user_id'] = $usd['id'];    
          $data22['share_user_id'] = $row['id'];
        ...
        $this->send_mail_to_registered_user($email, $data['note'],$data['bself_id']);
         //echo "sssssss";die;
         }
       return 1;
  ...
  <tr style="background-color: #fff;">
    <td width="27%" style="color: #000;"><p>Dear Publisher/Editor,</p>

    <p>'.$note.'</p>

    <p>Please <a href="http://billbahadur.com/demo/inkubate/bookshelves">click here</a> to view</p>
