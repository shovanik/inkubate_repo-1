   ...
   function get_twit_user($twid)
    ...
    function get_twit_user_byemail($twemail)
    {
        $data=array();
         ...
         $data  = $this->db->select('*')->where('email', $twemail)->get('users')->row_array();
...
<p>Your request for an invitation to Inkubate has been approved. Please click <a href="http://inkubate.com/application/home/success_sign/'.$unqid.'">http://inkubate.com/application/home/success_sign/'.$unqid.'</a> to finish the registration process. *If this link does not work, copy and paste the URL into your browser.</p>
