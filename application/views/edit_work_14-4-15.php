    ...
    Works uploaded: 1</p>-->
     ...
     Your image will appear after you click Save work.</p>
         ...
         <?php } } ?>   
            ...
            <label><button class="upld_butt2" type="button" style="background-color:#39302c;margin-left: 90px;" onclick="del_work(<?=$workdetails['id']?>)">Delete Work</button></label>
            <label><button class="upld_butt2" style="background-color:#46b8ff;float: right;margin-right: 22px;" value="Save" name="command" type="submit">Save Work</button></label>
            <div class="clear"></div>
