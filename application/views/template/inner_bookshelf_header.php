...
<!--style sheet-->
<!--jquery_link-->
<link href='<?=base_url()?>js/standalone/css/selectize.default.css' rel='stylesheet' />
 <script src="<?=base_url()?>js/standalone/jquery.js"></script> 
 <script src="<?=base_url()?>js/standalone/selectize.js"></script>
<script src="<?=base_url()?>js/standalone/index.js"></script> 
...
$(document).ready(function() {
 ...
 {
    //gapi.auth.signOut();
    document.location.href = "https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=http://billbahadur.com/demo/inkubate";
 }
            ...
            <div class="clear"></div>
                ...
                <div class="nav_section">
                        ...
                        <?php } ?>   
                            ...
                            <a href="<?=base_url()?>home/author/?mywork=1">
