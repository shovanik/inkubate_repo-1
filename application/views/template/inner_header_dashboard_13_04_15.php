  ...
  <div class="wrapper_content">
    ...
    <div class="nav_section">
      ...
      if($usd['user_type'] == '1') {
        ...
        <?php } } if($usd['user_type'] == '3') {
        if($this->uri->segment(2) == 'agent') {?> 
        <li  <?php if($this->uri->segment(2) == 'agent') {?> class="active" <?php } ?>><a href="<?=base_url()?>home/agent"><span <?php if($this->uri->segment(2) == 'agent') {?> class="active" <?php } ?>>My Dashboard</span></a></li>
        <?php } else { ?>
        <li><a href="<?=base_url()?>home/agent"><span>My Dashboard</span></a></li>
        <?php } }?>
        ...
        <?php 
                            if($usd['user_type'] == '1') {?>
                            <li <?php if($this->uri->segment(2) == 'addWork') {?> class="active" <?php } ?>><a href="<?=base_url()?>home/addWork"><span <?php if($this->uri->segment(2) == 'addWork') {?> class="active" <?php } ?>>My Work</span></a></li>
						    <?php } ?>
