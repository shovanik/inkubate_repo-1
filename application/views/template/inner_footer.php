...
<div class="clear"></div>
        ...
        <div class="sub-footer section clearfix">
			<strong>&copy; <?=date('Y')?> Inkubate.</strong> All rights reserved.
...
<div id="showAuthorList_draft" style="display:none;">
 ...
 <div id="showAuthorList_reply" style="display:none;">
    <h2>Your Address Book</h2>
    <?php
    if(isset($author_list))
    {
    ...
    <ul class="alphabet">
                                	<li><a href="javascript:;" onclick="FnAuthors_common('a','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')"  id="a">A</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('b','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="b">B</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('c','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="c">C</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('d','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="d">D</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('e','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="e">E</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('f','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="f">F</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('g','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="g">G</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('h','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="h">H</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('i','<?php echo $page;?>','<?php echo $per_page;?>')" id="i">I</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('j','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="j">J</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('k','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="k">K</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('l','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="l">L</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('m','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="m">M</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('n','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="n">N</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('o','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="o">O</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('p','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="p">P</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('q','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="q">Q</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('r','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="r">R</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('s','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="s">S</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('t','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="t">T</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('u','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="u">U</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('v','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="v">V</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('w','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="w">W</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('x','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="x">X</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('y','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="y">Y</a></li>
                                	<li><a href="javascript:;" onclick="FnAuthors_common('z','<?php echo $page;?>','<?php echo $per_page;?>', 'reply')" id="z">Z</a></li>
    ...
    if(isset($author_list) && count($author_list) > 0)
    {
        ...
        {
    ?>    
        <span class="selectAuthor_reply" data-num="<?php echo $i?>" style="background: #d0e6fe;color:#333;border-radius:4px;padding: 5px;margin: 0 10px 5px 0;cursor:pointer; float: left;width:45% ;" data-id="<?php echo $eachList['id']?>" data-name="<?php echo $eachList['name_first'].' '.$eachList['name_middle'].' '.$eachList['name_last'];?>" data-type="reply">
        <?php //echo word_wrap($eachList['email'],30)
        	echo $eachList['name_first']." ".$eachList['name_middle']." ".$eachList['name_last'];
        ?>
        </span>
