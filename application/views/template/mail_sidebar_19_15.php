...
{
    if(confirm("Are you sure to delete the "+msg_type+"?")){
    	 $.ajax({
    ...
    <div style=" width:100%; background:#000; padding:20px 0;">
     ...
     <div class="clear"></div>
			...
			<?php } ?>
                        ...
                        <li <?php if(isset($mail_sidebar) && $mail_sidebar == "2"){ ?>class="active"<?php } ?>><a href="<?=base_url()?>home/DraftMail"><img src="<?=base_url()?>images/icon_indox02.png" alt=""/>Draft<?php echo (isset($draft_count) && $draft_count > 0) ? '<span class="pink" id="drft_cnt">'.$draft_count.'</span>' : "";?></a></li>
                        ...
                        <li <?php if(isset($mail_sidebar) && $mail_sidebar == "4"){ ?>class="active"<?php } ?>><a href="<?=base_url()?>home/addressBook" ><img src="<?=base_url()?>images/icon_indox02.png" alt=""/>AddressBook</a></li>
                        <li <?php if(isset($mail_sidebar) && $mail_sidebar == "7"){ ?>class="active"<?php } ?>><a href="<?=base_url()?>home/pitchits_inbox"><img src="<?=base_url()?>images/icon_p.png" alt="" height="20"/>Pitchits Inbox<?php echo ($pitchit_count > 0) ? '<span class="pink">'.$pitchit_count.'</span>' : "";?></a></li>
                        ...
                        <li <?php if(isset($mail_sidebar) && $mail_sidebar == "6"){ ?>class="active"<?php } ?> style="position:relative">
                            <a class="hidetext no_effect" href="javascript:;" id="folder_a">
                        ...
                        <div style="display:block;" class="bottom_text">
                        
                        <strong>
                            <span href="javascript:;" onclick="folder_message(<?php echo $fdetails['id']?>,'<?php echo $fdetails['name']?>','folder')" title="<?php echo $fdetails['name']?>">
                        ...
                        <li <?php if(isset($mail_sidebar) && $mail_sidebar == "6"){ ?>class="active"<?php } ?> style="position:relative">
                            <a class="hidetext no_effect" href="javascript:;" id="pitchit_a">
                                <img src="<?=base_url()?>images/icon_p.png" alt="" height="20">Pitchits!<span class="plus"></span><br/>
                        ...
                        <div style="display:block;" class="bottom_pitchit">
