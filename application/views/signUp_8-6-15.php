...
<script type="text/javascript">
  ...
  function render() {
    gapi.signin.render('customBtn', {
      ...
      'clientid': '151275758111-spvfmff1nfpqv02i5l8ocvth7jmcu5ks.apps.googleusercontent.com',
 ...
 function fblog()
 {
   window.open('<?=$login_url?>','Facebook','width=500,height=300,top=300,left=400'); 
 } 
  
 function twitlog()
 {
   window.open('<?=base_url()?>twtest','Twitter','width=500,height=300,top=300,left=400'); 
 }
 function linkedlog()
 {
   window.open('<?=base_url()?>linkedin_signup','LinkedIn','width=500,height=300,top=300,left=400'); 
 } 
  </script>
 ...
 $('#facebook').click(function(e) {
 ...
 },{scope: 'email,user_photos'}); //permissions for facebook
});
   </script>      
  ...
  <div class="p_body_total" id="google_plus_id">
   ...
   <!-- <h1>Sign-Up</h1>
    ...
    <a href="javascript:void(0);" id="facebook"><img src="<?=base_url()?>images/facebook.png" /></a></li>
    <li><a href="javascript:void(0);" onClick="twitlog()"><img src="<?=base_url()?>images/twitter.png" /></a></li>
    <li>
   <!-- <button class="g-signin" id="customBtn"
    ...
    <li><a href="javascript:void(0);" onClick="linkedlog()"><img src="<?=base_url()?>images/linkedin.png" /></a></li>
    </ul>
    </div>
    <div class="clear"></div>
    <p class="join_t">Or</p>
