...
<style>
	...
	.owl-item{ padding:0 !important;}Bookshelf
...
<div class="mid_content index_sec">
	<div class="pitchits_section pitchits_section_new pitchits_section_new3 pitchits_section_new4">
		<div class="pit_work_dialog_lat_first popup_chng" style="display: none;" id="pit_work_dialog">
			...
			<a  class="green_but" href="#bookshelf_add_1" rel="facebox">Add to Bookshelf</a><a href="javascript:void(0);" id="cancl_pit" class="blue_but">Close</a>
		</div>
				...
				<div style="display: block;" id="tab1" class="work_main_tab">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_new">
						...
						<tbody>
							...
							<tr>
								<td colspan="5">
									<p>Sorry! There are no BookShelves.</p>
								</td>
							</tr>
							<?php } 
                            if($total_rows > 5)
...
<!--                            <img src="<?=base_url()?>images/img_default_cover.png"/>-->
                            <div class="no_profile_pic">
                                <div style="text-align: center; font-weight:600; line-height:15px; padding-top:10px; font-size: 10px; cursor: pointer;" title="<?=$total_work['title']?>"><?=substr(strtoupper($total_work['title']),0,13)?></div>
...
<!--                        <div class="no_profile_pic"><div style="padding: 20px 0 0 0;text-align: center; position: relative;">    
 ...
 <div class="clear"></div>
					...
					<p>Format : <?=$total_work['type_name']?></p>
                    <p>Genre : <?=$total_work['form_name']?></p>
...
<!--                                <img src="<?=base_url()?>images/img_default_cover.png"/>-->
                                <div class="no_profile_pic">
                                	<div style="text-align: center; font-size: 7px; cursor: pointer;" title="<?=$total_work['title']?>"><?=substr(strtoupper($total_work['title']),0,13)?></div>
            ...
            Genre: <?=$total_work_saved['form_name']?>
    </p>
