...
<!--                            <img src="<?=base_url()?>images/img_default_cover.png"/>-->
                            <div class="no_profile_pic"><div style="padding: 20px 0 0 0;text-align: center;" title="<?=$total_work['title']?>"><?=substr(strtoupper($total_work['title']),0,6)?></div></div>
...
<!--                        <div class="no_profile_pic"><div style="padding: 20px 0 0 0;text-align: center; position: relative;">    
 ...
 <div class="clear"></div>
                   ...
                   $full_name = $total_work['name'].' '.$total_work['name_middle'].' '.$total_work['name_last']; 
                    ...
                    <?php    
                     echo substr($full_name,0,6).'..';
                     ?>
                     <span class="tp_span28"><?=$full_name?></span>
                    </a>
                    <?php 
                    }
                    else
			...
			<div class="work_tab33">
                ...
                <div class="item" id="book<?php echo $total_work_saved['wcid'];?>">
                        ...
                        <div class="item_left_section">
                                ...
                                <?php } else { ?>
<!--                                <img src="<?=base_url()?>images/img_default_cover.png"/>-->
                                <div class="no_profile_pic"><div style="padding: 20px 0 0 0;text-align: center;" title="<?=$total_work_saved['title']?>"><?=substr(strtoupper($total_work_saved['title']),0,6)?></div></div>
                                <?php } ?>
                        </div>
                        <div class="item_right_section">
                                <p>
