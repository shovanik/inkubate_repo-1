            ...
            <div class="<?php if(count($merge_array) >4){?>demo1<?php }?> demo3 demo_new">
                <ul>
                    ...
                    <li>
                        ...
                        ?>
                        <strong> (<?= date("m/d/Y", strtotime($feeds_row['create_date'])); ?>) - </strong>
                        <a href="<?= $feeds_row['link']; ?>" target="_blank">
		   ...
		   <div class="top_compose">
                                       ...
                                       ?>
                                        ...
                                        <div class="comm_tarea">
                                            ...
                                            <input name="send" type="submit" value="Sent" class="button" style="margin-left: 10px;" />
