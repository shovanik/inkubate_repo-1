...
.invite_msg_success{ padding:6px 13px; margin:-3px 0 0 0; border-radius:10px; color:#fff; background:#46b8ff; position: absolute; right:0; font-size:12px;}
      ...
      <div class="mid_content index_sec mid_content_new">
            ...
            if(!empty($pitchit_details_limit))
        {
          ...
          <span style="float:left; margin-right:7px;"><?php if(!empty($user_photo['filename'])) {?>
            ...
            <p style="font-size:12px; float:left;">Welcome<span class="prsn_con">
          ...
          ?>        
                ...
                $(document).ready(function () {
                  ...
                  <div id="pit_work_dialog_vw22_<?=$pitch_details['pit_id']?>" style="display: none;" class="pit_work_dialog">
                    ...
                    <a href="javascript:void(0);" id="cancl_pit_vw_<?=$pitch_details['pit_id']?>" class="green_but">Close</a>
 ...
 <div class="clear"></div>
                ...
                $(document).ready(function () {
                  ...
                  <?php if(!empty($pitchit_view_user)) { ?>
                    ...
                    <p><?=$pitch_details['pitchit'];?></p>
                    <a href="javascript:void(0);" id="cancl_pit_<?=$pitch_details['id']?>" class="green_but">Close</a>
                    <!--<a href="###" onclick="click_edit_pit()">Edit</a><a href="#">Save</a><a href="#">Cancel</a><a href="#">PitchIt!</a>-->
                  </div>
           ...
           if(strlen($pitch_details['pitchit']) > 16)
                ...
                $(document).ready(function () {
                  ...
                  <a href="javascript:void(0);" id="cancl_pit_rep_all_<?=$pitch_details['id']?>" class="green_but">Close</a>
