...
<!--                        <span><a href="javascript:(void);" onclick="delete_feeds_url('<?= $url_list['id'];?>')"><img src="<?=base_url()?>images/delete_new.png" alt="" /></a></span>-->
              ...
              <div id="info_feed" style="display:none;">
                <div class="pop_new">
                 ...
                 <input name="feeds_url" id="feeds_url" class="folder_create_name" type="text" />
        ...
        ?>
            <div class="<?php if(count($feeds_details) >4){?>demo1<?php }?> demo3 demo_new">
                <ul>
                    <?php
                   ...
                   { 
                    ...
                    <a href="<?=$pit_url?>">
                        ...
                        <?= (strlen($val22[$j]['pitchit']) > 78) ? substr($val22[$j]['pitchit'], 0,78)."..." : $val22[$j]['pitchit']; ?>
                ...
                var p;
                    ...
                    if(data.status == "true")
                    {
                        ...
                        for (var i = 0, p; p = ps[i++];) 
                        {
                         ...
                         if(p.pitchit.length > 25)
                         {  
                           var trimmedString = p.pitchit.substring(0, 25)+'..'; 
