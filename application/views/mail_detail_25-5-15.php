                ...
                <div class="top_reply">
                   ...
                   <form name="replyFrm" id="replyFrm" method="post" action="<?php echo base_url();?>mail/replybox" enctype="multipart/form-data"> 
                    ...
                    <div class="text_field_box">
                        ...
                        <input type="hidden" id="pitchit_id" name="pitchit_id" value="<?php echo $single_mail_details['pitchit_id']?>"/>
...
<?php
if($single_mail_details['in_replied_section']==0)
{
?>
<div class="mid_content_inner_right_bottom_box_new">
<?php /* <p class="right_date"><span>Date </span>: <strong><?php echo date('m/d/y',strtotime($single_mail_details['msg_created']))?></strong></p> */?>
<p class="right_date"><span><?php echo date('F d Y',strtotime($single_mail_details['msg_created']))?> </span> at <strong><?php echo date('H:i A',strtotime($single_mail_details['msg_created']))?></strong></p>
<div class="drop_menu_section_left">
<div class="prof">
    <div class="drop_menu_section_left_text">
        ...
        <input type="checkbox" id="checkbox67_<?php echo $single_mail_details['id'];?>" name="check" class="css-checkbox lrg check1" value="<?php echo $single_mail_details['id'];?>">
        <label for="checkbox67_<?php echo $single_mail_details['id'];?>" name="checkbox67_lbl" class="css-label lrg web-two-style check1"></label>
    ...
    <span>To</span>: <strong><?php echo trim($single_mail_details['name_first'].' '.$single_mail_details['name_last']);?> </strong><!--<img src="<?=base_url()?>images/add_con.png" alt="" />--><br /></p>
