		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url('categories')?>">Categories/Subcategories</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
                	<div class="portlet">
                        ...
                        <div class="portlet-body">
                            ...
                            <input type="hidden" name="work_type_hid" id="work_type_hid" value="1" />
                                <div class="form-group">
                                <label class="col-md-3 control-label">Select Work Type :</label>
                                <div class="col-md-3">
                                <div class="radio-list">
											<label class="radio-inline">
											<input type="radio" name="optionsRadios" id="optionsRadios4" value="1" onchange="get_category(this.value)" checked> Fiction </label>
											<label class="radio-inline">
											<input type="radio" name="optionsRadios" id="optionsRadios5" value="2" onchange="get_category(this.value)"> Non Fiction </label>
...
<div style="margin: 0 0 0 240px;">
                    ...
                    <!--<div>
                        ...
                        <div>
                            <input type="radio" name="work_type" id="work_type" value="1" checked="checked" onclick="get_category(this.value)" /> &nbsp; Fiction&nbsp;&nbsp;
                            <input type="radio" name="work_type" id="work_type" value="2" onclick="get_category(this.value)" /> &nbsp; Non Fiction
                        </div>
                     </div>
