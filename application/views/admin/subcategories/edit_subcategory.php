...
<div class="page-container">
    ...
    <div class="portlet-body">
    	<form class="form-horizontal" role="form" method="post" action="<?= base_url('subcategories/update_subcategory')?>">
        ...
        <?php }?>
        <input type="hidden" name="cat_id" id="cat_id" value="<?php echo $category_by_id['id'];?>" />
        ...
        <select class="form-control" name="category" id="category"">
            ...
            <?php foreach($categories as $cat_row){?>
                <option value="<?= $cat_row['id']?>" <?php if($cat_row['id'] == $category_by_id['pid']){?>selected<?php }?>><?= $cat_row['categories']?></option>
            <?php }?>
        </select>
        </div>
        </div>
        ...
        <div class="radio-list">
			...
			<input type="radio" name="work_type" id="work_type" value="1" <?php if($category_by_id['work_type_id'] == 1){?>checked<?php }?>> Fiction </label>
			<label class="radio-inline">
			<input type="radio" name="work_type" id="work_type" value="2" <?php if($category_by_id['work_type_id'] == 2){?>checked<?php }?>> Non Fiction </label>
        ...
        <div class="radio-list">
			<label class="radio-inline">
                <input type="text" name="sub_cat" id="sub_cat" value="<?= $category_by_id['categories']?>" />
			</label>
		</div>
        </div>
