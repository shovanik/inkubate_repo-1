...
$(document).ready(function(){
  var hid_genre = $("#hid_gener").val();
  $("#cate_gory_hid_chosen ul").prepend(hid_genre);

 
 //$("#singleFieldTags").tagit();
  var hid_tag = '<ul class="tagit ui-widget ui-widget-content ui-corner-all"><li class="tagit-choice ui-widget-content ui-state-default ui-corner-all tagit-choice-editable"><span class="tagit-label">aaa</span><a class="tagit-close"><span class="text-icon">×</span><span class="ui-icon ui-icon-close"></span></a></li><li class="tagit-choice ui-widget-content ui-state-default ui-corner-all tagit-choice-editable"><span class="tagit-label">aaaaa</span><a class="tagit-close"><span class="text-icon">×</span><span class="ui-icon ui-icon-close"></span></a></li><li class="tagit-choice ui-widget-content ui-state-default ui-corner-all tagit-choice-editable"><span class="tagit-label">ddd</span><a class="tagit-close"><span class="text-icon">×</span><span class="ui-icon ui-icon-close"></span></a></li><li class="tagit-new"><input type="text" class="ui-widget-content ui-autocomplete-input valid" autocomplete="off"></li></ul>';
 //$("#singleFieldTags").addClass("tagit-hidden-field valid")
 //$("#singleFieldTags").after(hid_tag);
...
.cke_chrome{margin-top:10px !important;}
    ...
    Works uploaded: 1</p>-->
                ...
                <div class="profile_pic_2" style="display: table-cell;text-align: center;vertical-align: middle;"> 
     ...
     Your image will appear after you click Save work.</p>
          ...
          <div class="profile_right1" style="position:relative;">
           ...
           <option value="2" <?php if($workdetails['work_type_id'] == '2') { ?>selected="selected" <?php } ?>>Non-Fiction</option>
             ...
             <div style="position:absolute; padding-left:245px;">
                <?php 
                 $work_tag_details = $this->mwork->work_tags_details($workdetails['id']);
          ...
          <div class="clear"></div>
           ...
           <ul id="cat_list" style="margin-top:5px;">
            ...
            if(!empty($work_cat_details))
              ...
              $cat_hid_gnr.='<li class="search-choice" id="search-choice-'.$catdetails['wcid'].'"><span>'.$catdetails['category_name'].'</span><a onclick="catshow('.$catdetails['wcid'].')" class="search-choice-close" data-option-array-index="2"></a></li>';
            ?>
         ...
         <?php } } ?>   
            ...
            <input type="hidden" id="hid_gener" name="hid_gener" value='<?php echo $cat_hid_gnr;?>'>
           </span>
            ...
            <div class="rad_sec" style="background:#fff; height:0px; width: 96.6%;">
            
            <div class="fileContainer1" style="width:24%;">
            ...
            <div class="syn_con3" style="width:38%; text-align: left; padding: 32px 10px 0">Please upload your manuscript here.Inkubate accepts DOC,DOCS and PDF files that are under 25MB in size.</div>
            
           <!-- <label><button class="upld_butt2" type="button">Edit Work</button></label> -->
            
            <div class="right_pan">
            <label><button class="upld_butt2" type="button" style="background-color:#a6c139; padding:0 20px; margin-right:5px;" onclick="del_work(<?=$workdetails['id']?>)">Delete Work</button></label>
            <label><button class="upld_butt2" style="background-color:#46b8ff; padding:0 20px; margin-right:0;" value="Save" name="command" type="submit">Save Work</button></label><div class="clear"></div></div>
           ...
           <!--  <table style="width:97%">
              <tr>
                <td style="width:24%; float:left"><label class="fileContainer1">
                                <span class="upld_butt1">Upload Manuscript </span>
                                <input type="file" id="image1" name="image1" onchange="myFunction1()"/>
                                
            </label></td>
                <td style="width:38%; float:left"><label class="syn_con3" style="width:80%">Please upload your manuscript here.Inkubate accepts DOC,DOCS and PDF files that are under 25MB in size.</label></td>
                <td style="width:16%; float:right"><label><button class="upld_butt2" style="background-color:#46b8ff;" value="Save" name="command" type="submit">Save Work</button></label></td>
                <td style="width:17%; float:right"><label><button class="upld_butt2" type="button" style="background-color:#39302c;" onclick="del_work(<?=$workdetails['id']?>)">Delete Work</button></label></td>
              </tr>
            </table>
 -->
        ...
        //alert(resp);
            if(resp != '0'){
              $("#search-choice-"+cat).remove();
                ...
                //$("#cate_cnt").html(cat[0]);
                //$("#cat_list").html(cat[1]);
                $('.chosen-select').chosen({max_selected_options: resp });
                //$("#edit_class" ).dialog( "close" );
                ///////////////////
