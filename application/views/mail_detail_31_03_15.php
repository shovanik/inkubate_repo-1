...
<span>
    ...
    <a href="#0"  class="reply-popup-trigger"><input name="button" type="button" value="" class="button01" alt="reply" title="reply"/></a>
...
<span>
<a href="#0"  class="forward-popup-trigger"><input name="button" type="button" value="" class="button05" style="border-right: 0;" alt="forward" title="forward"/></a>
    ...
    <div style=" width:100%; background:#000; padding:20px 0;">
		   ...
		   <div class="top_forward">
                                       ...
                                       ?>
                                        ...
                                        <div class="text_field_box3"><label style="float:left; margin-top:9px;">Subject1234</label>
