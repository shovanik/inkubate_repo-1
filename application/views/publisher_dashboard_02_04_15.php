...
function ajaxSavedPitchit(page_saved)
{
    ...
    $.ajax({
       url      : '<?=base_url()?>'+'home/ajax_saved_pitchit_search',
       type     : 'POST',
      ...
      <div class="top_welcome_section_left">
	   <?php 
        ...
        <ul>
          ...
          <li><a href="javascript:void(0);" class="pink_icon hidetext3 tip_trigger" id="notify"><span class="tip" id="msg_id">Click to view Inkubate messages</span></a><span class="pink" id="cnt"><?php echo count($user_notification_count)?></span></li>
          
          
          <li><a href="javascript:void(0);" class="orange_icon hidetext4 tip_trigger1" id="pitchit"><span class="tip1" id="pit_id">Click to view PitchIt! messages</span></a><span class="orange" id="pitcnt"><?php echo $pitchit_count['count'];?></span></li>
...
//print_r($pitch_details);//die;
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_new">
              <thead>
                <tr>
                  ...
                  <th width="22%"><div>Sent By</div></th>
                  <th width="25%"><div>PitchIt! Message</div></th>
                  <th width="18%" class="center"><div>Edit</div></th>
 ...
 <div class="clear"></div>
                ...
                $(document).ready(function () {
                  ...
                  <p><?=$pitch_details['pitchit'];?></p>
                  <a href="javascript:void(0);" class="yellow_but" id="edit_pitch_<?php echo $pitch_details['pit_id']?>">Edit</a>
                  <a href="javascript:void(0);"  class="blue_but" id="save_pitch<?=$pitch_details['pit_id']?>">Save</a>   
            ...
            <?php if($total_pit_save_cnt > 10) {?>
            <div class="paginate_div">
            <?php if($total_pit_save_cnt > $offset_saved){ ?><a href="javascript:;" onclick="ajaxSavedPitchit(<?php echo $page_saved+1;?>)" class="blue_but floright_martop">VIEW OLDER</a><?php }else{?> <a href="javascript:;" class="blue_but floright_martop">VIEW OLDER</a> <?php } ?>
 ...
 <div class="clear"></div>
                ...
                $(document).ready(function () {
                  ...
                  <a href="javascript:void(0);" id="cancl_pit_rep_vwall_<?=$pit_details['pit_id']?>">Close</a>
