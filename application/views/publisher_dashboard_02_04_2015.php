...
//print_r($pitch_details);//die;
 ...
 <div class="clear"></div>
            ...
            <?php if($total_pit_save_cnt['count'] > 5) {?>
            <div class="paginate_div">
            <?php if($total_pit_save_cnt['count'] > $offset_saved){ ?><a href="javascript:;" onclick="ajaxSavedPitchit(<?php echo $page_saved+1;?>)" class="blue_but floright_martop">VIEW MORE</a><?php }else{?> <a href="javascript:;" class="blue_but floright_martop">VIEW OLDER</a> <?php } ?>
