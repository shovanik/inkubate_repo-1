...
<!--                        <span><a href="javascript:(void);" onclick="delete_feeds_url('<?= $url_list['id'];?>')"><img src="<?=base_url()?>images/delete_new.png" alt="" /></a></span>-->
        ...
        <?php 
            ...
            shuffle($merge_array);
            //print_r($merge_array[0]);
            //$k = array_rand($merge_array);
            //$v = $array[$k];
        ...
        ?>
            <div class="<?php if(count($merge_array) >4){?>demo1<?php }?> demo3 demo_new">
                <ul>
                    ...
                    $i=1;
                    $j = 0;
                     $merge_array_cnt = count($merge_array); 
    ...
    <div class="pitchits_section pitchits_section_new">
          <div class="pitchits_section_left">
            ...
            <ul class="list" id="tabs">
              ...
              <li id="current4" class="hov_col"><a href="javascript:void(0)" name="tab4" >PitchIt! Responses<span>
  ...
  <div class="cd-popup" role="alert" id="cd-popup_rep_vwall_prd_<?php echo $pitch_details['pit_id']?>">
    ...
    <div style=" width:100%; background:#000; padding:20px 0;">
     ...
     <div class="clear"></div>
                  ...
                  <div class="pitchit_conversation_icon">
                  <img src="<?=base_url()?>images/think.png" alt="" style="cursor: pointer;"/> 
                  <?php
                  if(strlen($pitch_details['pitchit']) > 15){?>
                    <div title="<?php echo $pitch_details['pitchit'];?>"><?php echo substr($pitch_details['pitchit'],0,15).'..';?></div>
                  <?php } else {
...
//print_r($pitch_details);//die;
 ...
 <div class="clear"></div> -->
                  ...
                  <?php /* <td class="center"><?php //echo $pitchit_view;?>
              ...
              <tbody>
               ...
               <?php 
                ...
                $(document).ready(function () {
                 ...
                 <!--No Reply-->
                  ...
                  <span id="pit_work_lat_first_vall_<?=$pit_details['pit_id']?>" style="cursor: pointer;">
                   
                  <?php if(strlen($pit_details['pitchit']) > 30) {?>
                      <div title="<?php echo $pit_details['pitchit'];?>"><?php echo substr($pit_details['pitchit'],0,30).'..';?></div>
                  <?php } else { 
                      echo $pit_details['pitchit']; 
                    }?>
               ...
               <script type="text/javascript">
                $(document).ready(function () {
                   ...
                   $('#pit_work_lat_first_vall_'+<?=$pit_details['pit_id']?>).click(function () {
                        
                            $('.pit_work_dialog').hide();
                            $('.pit_work_dialog_vw').hide();
                            $("#pit_work_dialog_lat_first_vall_"+<?=$pit_details['pit_id']?>).dialog({
                                position:  {
                                            my: "left",
                                            at: "left",
                                            of: $('#tab3')
                        ...
                        $("#pit_work_dialog_lat_first_vall_"+<?=$pit_details['pit_id']?>).show();    
                        
                    });
                    
                     $('#cancl_pit_vall_'+<?=$pit_details['pit_id']?>).click(function () {
                       
                            
                            $("#pit_work_dialog_lat_first_vall_"+<?=$pit_details['pit_id']?>).hide();
                  ...
                  <div id="pit_work_dialog_lat_first_vall_<?=$pit_details['pit_id']?>" style="display: none;" class="pit_work_dialog">
                  ...
                  <a href="javascript:void(0);" id="cancl_pit_vall_<?=$pit_details['pit_id']?>" class="green_but">Close</a>
                  </div>
	...
	$('#cd-popup-trigger_first_vall_'+<?php echo $pit_details['pit_id']?>).on('click', function(event){
		event.preventDefault();
		$('#cd-popup_first_vall_'+<?php echo $pit_details['pit_id']?>).addClass('is-visible');
	});
              ...
              <tbody>
                   ...
                   if(!empty($pitchit_details_limit_original))
                    ...
                    $i =1; 
                       ...
                       foreach($pitchit_details_limit_original as $k =>$pitch_details)
                     {
                        ...
                        $pitchit_msg_pub = $this->memail->get_user_pitchit_msg_from_pub($pitch_details['pit_id']);
                        //print_r(count($pitchit_msg_pub));
                        if($pitchit_msg_pub['count'] > 0)
                        {
                     ?>
               ...
               <script type="text/javascript">
                $(document).ready(function () {
                  ...
                  <a href="#0" class="cd-popup-trigger" id="cd-popup-trigger_rep_<?php echo $pitch_details['id']?>" style="background: none !important;">
                  <img src="<?=base_url()?>images/think.png" alt=""/>
                  </a>
  ...
  <div class="cd-popup" role="alert" id="cd-popup_rep_<?php echo $pitch_details['id']?>">
    ...
    <div style=" width:100%; background:#000; padding:20px 0;">
     ...
     <div class="clear"></div>
            ...
            <?php if(!empty($pitchit_details_limit_total)) {
             if(count($pitchit_details_limit_total) > 5) {?>
            <div class="paginate_div">
          ...
          <!--<a href="#" class="button_pro">View Detail</a>--></span></h1>
           ...
           <div id="tabs_dem"> 
              <div class="box_section box_section_mar_right30">
                ...
                <div class="myclick_para" title="The Most Recent Titles Submitted by Writers"><div class="myclick_span"><?php echo $user_recently_add_titles_cnt; ?></div>
                  Recent Titles</div>
