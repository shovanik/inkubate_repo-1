              ...
              <?php 
                ...
                $(document).ready(function () {
                  ...
                  $(document).ready(function () {
                    ...
                    <h1>Saved <?=$pitch_details['title']?> Pitchit! <span id="success_pit" style="color: green; float:right; margin:2px 240px 0 0;font-size:15px"></span></h1>
 ...
 //BASE = "<?//=base_url()?>";
  ...
  $(document).ready(function() {
   ...
   $(document).ready(function () {
                    ...
                    <a href="javascript:void(0);" onclick="do_pit(<?=$pitch_details['pit_id']?>)" class="pitchit_pop_icon"><img src="<?php echo base_url();?>images/icon_p.png"></a>
                    </div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_new">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a class="tooltips" href="<?php echo base_url();?>discovery/user_details/<?php echo $total_viw['user_id'];?>" > 
        ...
        <div class="form_but">
            ...
            <input name="save" type="button" value="Close" class="green_but" style="cursor:pointer" id="cancl_work_pit" />
               ...
               <!-- <a href="javascript:void(0);" id="cancl_work_pit">Close</a>--> */?>
                ...
                {
                 	$full_name = '<a href="javascript:void(0);" class="tooltips">'.substr($full_name,0,12).'...<span class="tp_span28">'.$full_name.'</span></a>';
                }else{
                	$full_name = " ".$full_name;
                }
                ...
                <p>Genre: <?php if(!empty($user_category_details))
                    ...
                    if(strlen($cat_name) > 12){
                     	$cat_name = '<a href="javascript:void(0);" class="tooltips">'.substr(trim($cat_name),0,10).'...<span class="tp_span28">'.$cat_name.'</span></a>';
                    }else{
                    	$cat_name = $cat_name;
                    }
                    echo $cat_name;
...
function ajaxSavedPitchit(page)
{
    $.ajax({
       url      : '<?=base_url()?>'+'home/ajax_saved_pitchit_search_author',
       type     : 'POST',
