...
function draft_send(id)
{
    ...
    $.ajax({
           ...
           success  : function(data){
            ...
            var res = data.split("~");
            $("#email_selected_draft").html('<span class="choosen" id="fullname">'+res[1]+'</span>');
            $('#reply_email').val(res[0]);
            $('#fullname').html(res[1]);
            $('#user_mail_draft').val(res[1]);
            $('#reply_sub').val(res[2]);
            $('#user_email_id_draft').val(res[4]);
                ...
                <div class="top_replyall">
                   ...
                   <form name="replyFrm5" id="replyFrm5" method="post" action="<?php echo base_url();?>mail/draftAllbox" enctype="multipart/form-data"> 
                    ...
                    <div class="text_field_box">
                        ...
                        <input type="hidden" id="user_mail_draft" name="user_mail_draft" readonly="readonly"/>
                        <div  class="auto_main">				
                            <span id="email_selected_draft">
                                <span class="choosen" id="fullname"></span>
                            </span>
                            
                            <span>
                                <input type="text" autocomplete="off" class="auto_t_box" id="email_input_draft" name="email_input_draft" onkeyup='FnShowSearch_draft(this.value)'>
                                <ul id="dropdown_search_draft" class="dropdown_class_draft" style="display:none;">
                                </ul>
                            </span>
                           
                        </div>
                        <input type="hidden" id="user_email_id_draft" name="user_email_id_draft"/>
                        <label class="com_plus"> <a href="#showAuthorList_draft" class="nohover add_img" rel="facebox" data-url=""><img src="<?php echo base_url('images/plus_icon.png')?>" /></a></label>
        ...
        <div class="clear"></div>
         ...
         <?php } ?> </span>
                       ...
                       <?php /* <a class="mail_link " href="<?=base_url()?>mail/details/<?php echo $details['id']?>"><?php echo $details['subject']?></a> */ ?>
                        <a class="mail_link replyall-popup-trigger" href="javascript:void(0)" onclick="draft_send(<?=$details['id']?>)">
                          <?php
                        ...
                        <span title="<?php echo $details['subject'];?>"><?php echo substr($details['subject'],0,18).'..';?></span>
                            ...
                            ?>
                                            ...
                                            <a href="<?=base_url()?>mail/download/<?=$details['from_user_id']?>/<?=$details['attach_file']?>" class="mail_link"><img src="<?=base_url()?>images/attachment_icon.png" alt="" />&nbsp;</a>
         ...
         <?php } ?> </span>
                                            ...
                                            <?php //echo $myFormatForView = date("m/d/y g:i A", $details['created']); ?>
                                            <div class="clear"></div>
