    ...
    <div class="pitchits_section pitchits_section_new">
          <div class="pitchits_section_left">
            ...
            <ul class="list" id="tabs">
              ...
              <li  id="current2" class="hov_col"><a href="javascript:void(0)" name="tab2">Saved PitchIts!  <span><?=count($userSavedPitchitDetails);?></span></a></li>
              <li id="current3" class="hov_col"><a href="javascript:void(0)" name="tab3" >View All PitchIts! <span><?=count($userAllPitchitDetails);?>
              <?php
                      /*$res = array();
              ...
              <li id="current4" class="hov_col"><a href="javascript:void(0)" name="tab4" >PitchIt! Responses<span><?=count($pitchit_details_limit_original);?></span></a></li>
              <li id="current5" class="hov_col"><a href="javascript:void(0)" name="tab5" >Total Viewed PitchIts! <span><?=count($totalViewPitchit);?></span></a></li>
...
//print_r($pitch_details);//die;
 ...
 <div class="clear"></div>
            ...
            <?php if(count($userSavedPitchitDetails) > 5) {?>
            <div class="paginate_div">
            <?php if(count($userSavedPitchitDetails) > $offset_saved){ ?><a href="javascript:;" onclick="ajaxSavedPitchit(<?php echo $page_saved+1;?>)" class="blue_but floright_martop">VIEW MORE</a><?php }else{?> <a href="javascript:;" class="blue_but floright_martop">VIEW OLDER</a> <?php } ?>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_new">
              ...
              <tbody>
               ...
               <?php 
                   ...
                   if(!empty($userAllPitchitDetails))
                   {
                       /*$res = array();
                   ...
                   //echo '<pre/>';print_r($userAllPitchitDetails);//die; 
                    foreach($userAllPitchitDetails as $k => $pit_details)
                    { 
