...
function folder_message(id,str)
{
    ...
    window.location.href = '<?=base_url()?>home/folder/'+id+'/'+str;
         ...
         <?php } ?> 
                                                ...
                                                <span class="soph_con1 detail_for_mob"><a class="mail_link" href="<?=base_url()?>mail/details/<?php echo $details['id']?>" <?php echo ($details['is_viewed'] == "0" || $details['is_marked'] == "0") ? "style='font-weight:bold !important;'":""?> ><?php echo $details['subject']?></a></span>
                                                <div class="clear"></div>
                                            </div>
                                            <span class="atch">
                                            <!--<a href="#info" rel="facebox"><img src="<?//=base_url()?>images/attachment_icon.png" alt="" /></a></span>
