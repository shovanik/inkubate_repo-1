...
.fict_pan_gnre {width:46%; float:left;}
...
.name_con a {color: #45baff !important;}
.pub_con a {color: #696969 !important;}
.pub_con_2 a {color: #696969 !important;}
.pub_con_22 a {color: #696969 !important;}
</style>
           ...
           <span class="pub_con">
             ...
             <span class="pub_con">
              ...
              <?php 
                                                ...
                                                ?>
             <?php if(!empty($address)) { if(strlen($address) > 23)
                                                {
                                                   echo substr($address,0,23).'..';
                                                }
                                                else
                                                {
                                                    echo $address;
             ...
             <span class="pub_con_2"><a class="tooltips" href="javascript:void(0)" ><?php if(!empty($user_contact['city'])) { if(strlen($user_contact['city']) > 10)
                                                {
                                                   echo substr($user_contact['city'],0,10).'..';
                                                }
                                                else
                                                {
             ...
             <span class="pub_con_23"><a class="tooltips" href="javascript:void(0)" ><?php if(!empty($user_contact['country'])) { if(strlen($user_contact['country']) > 10)
                                                {
                                                   echo substr($user_contact['country'],0,10).'..';
                                                }
                                                else
                                                {
                                                    echo $user_contact['country'];
                                                } } else { echo 'No Country'; }?>
                <span class="tp_span2"> <?php if(!empty($user_contact['country'])) { echo $user_contact['country']; } else { echo 'No country'; }?></span>
                 <div class="clear"></div> 
                 </a>
                                                </span>
