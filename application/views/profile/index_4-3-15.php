    ...
    <h1>Personal Details</h1>
           ...
           <!--         <?php if($usd['user_type'] == '1') {?> 
                    ...
                    <ul>
                        ...
                        <li>
                        <h1 class="update_heading align_heading">Open to being contacted by publishers? <?php  if($user_contact['is_contacted'] == '1') { ?> YES <?php } else { ?> NO <?php } ?></h1> 
                        </li>
            ...
            <div class="profile_top_mid_sec t_part2">
            	<div class="profile_mid">
                  ...
                  <div class="auto_bio">
                  <h1><?php if($usd['user_type'] == 1){?>Author<?php } if($usd['user_type'] == 2) {?>Publisher<?php } ?> Bio</h1> 
                  <div class="editor_part" style="height: auto;">
                  <?php if(!empty($user_bio['biography'])) {?>
                  <?php echo stripslashes($user_bio['biography'])?>
                  <?php } ?>
                  </div>
         ...
         <div class="profile_bot_sec">
         	<div class="profile_bot_sec_left">
                ...
                <h1 style="padding-top:10px;">Others</h1>
                  	...
                  	<ul>
                    	<li><label>Have you been published by a professional publishing house? &nbsp;<strong><?php if(!empty($user_bio['traditionally_published'])) {if($user_bio['traditionally_published'] == '1') {?>yes<?php } else {?>no<?php } } ?> </strong></label></li>
                        <li><label>Have you self published?&nbsp;<strong><?php if(!empty($user_bio['self_published'])) {if($user_bio['self_published'] == '1') {?>yes<?php } else {?>no<?php } } ?></strong></label></li>
                        <li><label>Have you received literary awards?&nbsp;<strong><?php if(!empty($user_bio['literary_awards'])) {if($user_bio['literary_awards'] == '1') {?>yes<?php } else {?>no<?php } } ?></strong></label></li>
                        <li><label>Has your work been reviewed?&nbsp;<strong><?php if(!empty($user_bio['work_been_reviewed'])) {if($user_bio['work_been_reviewed'] == '1') {?>yes<?php } else {?>no<?php } } ?></strong></label></li>
                        <li><label>Have you published abroad?&nbsp;<strong><?php if(!empty($user_bio['published_abroad'])) {if($user_bio['published_abroad'] == '1') {?>yes<?php } else {?>no<?php } } ?></strong></label></li>
                        <li><label>Are you part of a creative writing MFA program?&nbsp;<strong><?php if(!empty($user_bio['mfa_program'])) {if($user_bio['mfa_program'] == '1') {?>yes<?php } else {?>no<?php } } ?></strong></label></li>
                    </ul>
