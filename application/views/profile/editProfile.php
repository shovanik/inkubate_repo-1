...
function checkPass()
{
    ...
    if(pass2.value == ''){
        ...
        message1.innerHTML = "Passwords Mismatch!";
    }
...
.fileContainer [type=file] {
      ...
      <div class="mid_content index_sec pro">
        ...
        <div class="pitchits_section">
                  ...
                  <?php
                   ...
                   if($user_contact['password']!=""){
                    ?>
                    <input type="hidden" name="pass_given" value="true">
                    <?php
                   }else{
                    ?>
                    <input type="hidden" name="pass_given" value="false">
                    <?php
                   }
                   ?>
    ...
    Works uploaded: 1</p>-->
               ...
               <?php 
                ...
                //echo '<pre/>';print_r($user_photo['filename']);die;
                ?>
               <?php if(!empty($user_photo['filename']) && file_exists("uploadImage/".$usd['id']."/profile/".$user_photo['filename']) ) {?>
                ...
                <div class="profile_pic_2">
                    ...
                    <div class="prf_img_ins profile_own">Insert Profile Image Here</div>
          ...
          <div class="profile_right1">
             ...
             <div class="profrgt_top">
               ...
               <input name="age" id="age" type="text" class="prfuitxtfld_box1" placeholder="Age" value="<?php if(!empty($user_contact['age'])) { echo $user_contact['age']; } ?>">
               
                <?php
               if($user_contact['email'] != '' && $user_contact['email'] != 0 )
               {
               ?>
               <input name="personal_email" type="text" class="prfuitxtfld_box1" placeholder="Email" value="<?php if(!empty($user_contact['email'])) { echo $user_contact['email']; } ?>">
              
               <?php } else { ?>
               
                <input name="personal_email" type="text" class="prfuitxtfld_error_box1" placeholder="Email" value="<?php if(!empty($user_contact['email'])) { echo $user_contact['email']; } ?>">
               ...
               <option value="US" <?php if($user_contact['country'] == 'US') { ?> selected <?php } ?>>United States</option>
               <?php foreach($countries as $country_row){?>
               <option value="<?=$country_row['country_code'];?>" <?php if($user_contact['country'] == $country_row['country_code']) { ?> selected <?php } ?>><?=$country_row['country_name'];?></option>
               <?php }?>
               </select>
               ...
               <input name="password" id="password" type="password" class="prfuitxtfld_error_box" placeholder="New Password" value="">
               <input type="password" name="con_password" id="con_password"  class="prfuitxtfld_error_box" onkeyup="checkPass(); return false;" placeholder="Confirm Password">
               <?php
               }else{
               ?>
                
               <input name="password" id="password" type="password" class="prfuitxtfld_box" placeholder="New Password">
               <input type="password" name="con_password" id="con_password"  class="prfuitxtfld_box" onkeyup="checkPass(); return false;" placeholder="Confirm Password">
               ...
               <span id="confirmMessage" class="confirmMessage" style="display: none;"></span>
               <span id="confirmMessage1" class="confirmMessage1" style="display: none;"></span>
               <div class="clear"></div>
            ...
            <span class="tp_span" style="top: 21px !important; left: 50px;">Create Your Bio</span>
            
            </a>
            </span>
            <span class="ed_icon">Click on the icon to edit your biography </span>
            <div class="clear"></div>
            ...
            <?php } } } ?>
                ...
                <option value="">-----------Title Interest Type----------</option>
            ...
            <div class="profuibutt_sec">
               <!-- <button class="upld_butt2" type="button" style="margin-right:14%; margin-top: 0px;">Edit Profile</button>-->
                <button class="upld_butt2" type="submit" style="background-color:#46b8ff; margin-top: 0px; padding: 0 24px !important; margin-left: 186px !important;">Save Profile</button>
                <div class="clear"></div>
            </div>
            <div class="clear"></div>
...
else
{
  var maxcnt =  -1;   
   ...
   $(".chosen-select").bind("chosen:maxselected", function () { alert('Your profile already has 5 genre categories selected. To change or add different genre categories to your profile, please delete the current genre categories on your profile page and then go back to the Edit Profile section’s What is your genre interest picklist to add more or different genres to your profile') });  
 ...
 $('#manuscript_total').keyup(function(){
  ...
  function limitText_manu(limitField,limitNum) {
    ...
    $(function(){
        $(".upld_butt2").on('click' , function(e){
          e.preventDefault();
          if($("input[name='pass_given']").val() == "false"){
