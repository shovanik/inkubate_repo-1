    ...
    Works uploaded: 1</p>-->
          ...
          <div class="profile_right2">
           ...
           <span class="name_con">
            ...
            <?php if(!empty($user_contact['name_first'])) { $name = $user_contact['name_first']; } ?> <?php if(!empty($user_contact['name_last'])) { $name.=' '.$user_contact['name_last']; }  
            if(strlen($name) > 15)
            {?>
...
//             }
             ...
             if(!empty($linkin['url'])) { 
             ?>
             <a href="https://linkedin.com/<?php echo $linkin['url'];?>" target="_blank"><img src="<?=base_url()?>images/in.png" alt=""><?php echo $linkin['url'];?></a>
             <?php } else {?>
