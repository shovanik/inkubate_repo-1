...
.fict_pan_gnre {float:left; width:100%;} 
...
.pub_con_22 a {color: #39302c !important;}
    ...
    Works uploaded: 1</p>-->
                ...
                <div class="profile_pic">
                 ...
                 <?php }else {?>
                        ...
                        <?php if($user_contact['social_source'] == 'twitter') { ?>
                            <img src="<?=$user_contact['social_image'];?>" style="border: 1px solid #444; height:135px; width: 152px;"/>
                            
                     <?php } elseif($user_contact['social_source'] == 'linkedin') { ?>
                        <img src="<?=$user_contact['social_image'];?>" style="border: 1px solid #444; height:135px; width: 152px;" />
                        
                   <?php } elseif($user_contact['social_source'] == 'facebook') { ?>
                        <img src="https://graph.facebook.com/<?=$user_contact['social_image'];?>/picture?type=large" style="border: 1px solid #444; height:135px; width: 152px;"/>
                  ...
                  <?php } elseif($user_contact['social_source'] == 'googleplus') { ?>
                    ...
                    <?php } elseif($user_contact['user_type'] == "2") {?>
                    <div class="profile_pic_7" style="margin-top:0; background-color : none !important;">
                        <img src="<?=base_url()?>images/ico_publishers1.png" style="border: 1px solid #444;" class="img_sz"/>
                     </div>
                    <?php } elseif($user_contact['user_type'] == "3") {?>
                    <div class="profile_pic_7" style="margin-top:0; background-color : none !important;">
                        <img src="<?=base_url()?>images/ico_agents1.png" style="border: 1px solid #444;" class="img_sz"/>
                     </div>
                    <?php } else {?>
                    <div class="profile_pic_7" style="margin-top:0; background-color : none !important;">
                        <img src="<?=base_url()?>images/ico_editors1.png" style="border: 1px solid #444;" class="img_sz"/>
                      </div>  
                    <?php } ?>
          ...
          <div class="profile_right2">
           ...
           <span class="pub_con">
            ...
            ?>
          ...
          else { echo '<a class="tooltips" href="javascript:void(0)" >No Street Address</a>'; }
             ?>
             ...
             <?php } }else{echo 'No Street Address ';} ?>
       ...
       <?php if(!empty($user_contact['city'])) { if(strlen($user_contact['city']) > 20)
            ...
            <span class="pub_con_23"><a class="tooltips" href="javascript:void(0)" ><?php if(!empty($user_contact['state']) && $user_contact['state']!='State') { if(strlen($user_contact['state']) > 10)
            {?>
            ...
            ?>
                ...
                <?php } } else {echo 'No Country Affiliation';} ?> 
		 ...
		 <span class="pub_con_23"><a class="tooltips" href="javascript:void(0)" ><?php if(!empty($user_contact['job_title'])) { if(strlen($user_contact['job_title']) > 10)
            {?>
                <div title="<?php echo $user_contact['job_title'];?>"><?php echo substr($user_contact['job_title'],0,10).'..';?></div>
               
            <?php }
            else
            {
                echo $user_contact['job_title'];
            } } else { echo 'No Job Title'; }?>
            
                 </a></span>

		<span class="pub_con_23"><a class="tooltips" href="javascript:void(0)" ><?php if(!empty($user_contact['industry']) && $user_contact['industry']!='Industry') { if(strlen($user_contact['industry']) > 10)
            {
	$insd	= explode('_',$user_contact['industry']);
	$industry	= ucfirst($insd[0]).' '.ucfirst($insd[1]);
?>
                <div title="<?php echo $industry;?>"><?php echo substr($industry,0,10).'..';?></div>
			...
			$industry	= ucfirst($insd[0]).' '.ucfirst($insd[1]);
			echo $industry;
            } } else { echo 'No Industry Affiliation'; }?>
...
//             }
             ...
             <?php
              ...
              if(!empty($fb['url'])) {
                if(strlen($fb['url']) > 15) {
             ?>
             <a href="https://facebook.com/<?php echo $fb['url'];?>" target="_blank" title="<?php echo $fb['url'];?>"><img src="<?=base_url()?>images/fb.png" alt="">
             <?php echo substr($fb['url'],0,15).'..';?>
             </a>
             <?php } else { ?>
             <a href="https://facebook.com/<?php echo $fb['url'];?>" target="_blank"><img src="<?=base_url()?>images/fb.png" alt="">
             <?php echo $fb['url'];?>
             </a>
             <?php } } else {?>
             ...
             if(!empty($rss['url'])) {
                if(strlen($rss['url']) > 15) {
             ?>
             <a href="https://plus.google.com/<?php echo $rss['url'];?>" target="_blank" title="<?php echo $rss['url'];?>"><img src="<?=base_url()?>images/g+.png" alt="">
             <?php echo substr($rss['url'],0,15).'..';?>
             </a>
             <?php } else { ?>
             <a href="https://plus.google.com/<?php echo $rss['url'];?>" target="_blank"><img src="<?=base_url()?>images/g+.png" alt="">
             <?php echo $rss['url'];?>
             </a>
             <?php  } } else {?>
             ...
             if(!empty($twt['url'])) { 
                if(strlen($twt['url']) > 15) {
             ?>
             <a href="https://twitter.com/<?php echo $twt['url'];?>" target="_blank"><img src="<?=base_url()?>images/tw.png" alt="">
             <?php echo substr($twt['url'],0,15).'..';?>
             </a>
             <?php } else { ?>
             <a href="https://twitter.com/<?php echo $twt['url'];?>" target="_blank"><img src="<?=base_url()?>images/tw.png" alt="">
             <?php echo $twt['url'];?>
             ...
             if(!empty($linkin['url'])) {
                if(strlen($linkin['url']) > 15) {
             ?>
             <a href="https://linkedin.com/pub/<?php echo $linkin['url'];?>" target="_blank"><img src="<?=base_url()?>images/in.png" alt="">
             <?php echo substr($linkin['url'],0,15).'..';?>
             </a>
             <?php } else {?>
             <a href="https://linkedin.com/pub/<?php echo $linkin['url'];?>" target="_blank"><img src="<?=base_url()?>images/in.png" alt="">
             <?php echo $linkin['url'];?>
            ...
            <td width="120px" valign="top"><span class="join_con1"><strong>Content Interest:</strong></span></td>
            
            <td valign="top" width="150px"><span class="fict_pan">
            ...
            <td width="120px" valign="top"><span class="join_con"><strong>Genre Interest:</strong></span></td>
            
            <td valign="top" width="350px"><span class="fict_pan_gnre">
             <?php  
//             if($user_id == $usd['id']){
