...
.url_link { color: #696969;}
    ...
    Works uploaded: 1</p>-->
          ...
          <div class="profile_right2">
             ...
             <span class="join_con2"><a class="url_link" href="<?php echo $fb['url'];?>"><?php echo $fb['url'];?></a></span>
             <?php } else {?>
             
             <span class="fb_icon"><img src="<?=base_url()?>images/fb.png" alt=""></span>
             <span class="join_con2">No Facebook</span>
             ...
             <span class="join_con2"><a class="url_link" class="url_link" href="<?php echo $rss['url'];?>"><?php echo $rss['url'];?></a></span>
             <?php } else {?>
             <span class="fb_icon"><img src="<?=base_url()?>images/g+.png" alt=""></span>
             <span class="join_con2">No Google+</span>
             <?php } ?> 
             ...
             <span class="join_con2"><a class="url_link" href="<?php echo $twt['url'];?>"><?php echo $twt['url'];?></a></span>
             <?php } else {?>
             <span class="fb_icon"><img src="<?=base_url()?>images/tw.png" alt=""></span>
             <span class="join_con2">No Twitter</span>
             <?php } ?>
             ...
             <span class="join_con2"><a class="url_link" href="<?php echo $linkin['url'];?>"><?php echo $linkin['url'];?></a></span>
            
             <?php } else{?>
             <span class="fb_icon"><img src="<?=base_url()?>images/in.png" alt=""></span>
             <span class="join_con2">No LinkedIn</span>
             <?php } ?> 
