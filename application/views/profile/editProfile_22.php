    ...
    Works uploaded: 1</p>-->
                ...
                <div class="profile_pic">
                    <img src="<?=base_url()?>_assets/<?=strtolower($latest_portrait['user_guid'])?>/<?=strtolower($latest_portrait['asset_guid']).'.'.$photo_extn?>"/>
                     ...
                     <div class="profile_pic_2">
                        <img src="<?=$user_contact['social_image'];?>" style="border: 1px solid #444; " />
                     </div>  
                     ...
                     <div class="profile_pic_2">
                      ...
                      <div class="profile_pic_2">
                       <img src="https://graph.facebook.com/<?=$user_contact['social_image'];?>/picture?type=large" style="border: 1px solid #444;"/>
                       </div>
          ...
          <div class="profile_right1">
             ...
             <div class="profrgt_top">
               ...
               <input name="password" type="password" class="prfuitxtfld_box" placeholder="password change" value="">
