...
function limitText(limitField, limitCount, limitNum) {
    ...
    <div class="content_part">
      ...
      <div class="mid_content">
            ...
            <label class="b_left_t">Pitchits!</label> 
            <div class="clear"></div>
        </div>
                ...
                <tr class="pitchits_table_content">
                  ...
                  <?php } ?>
                    ...
                    <td>
						...
						<p class="foot">
						<strong><?=$pitch_details['work_type_name']?></strong><br />
						<strong>Categories: <span class="c_name">
                    ...
                    <?php 
                    if(strlen($user_pit_details['pitchit']) <= 60)
                    {
                      echo $user_pit_details['pitchit'];
                    }
                    else
                    {
                      echo substr($user_pit_details['pitchit'],0,60).'..';  
                    }
                    ?>"
                    <span><?php  echo $user_pit_details['pitchit']?></span></a></td>
                    <td align="center"><?php echo date('m/d/Y',strtotime($user_pit_details['created_date']))?></td>
                   <td align="left">
                   <a href="<?=base_url()?>home/compose_mail/<?=$pitch_details['user_id']?>/<?php echo $user_pit_details['pit_id']?>">
                   <input type="button" class="share_btn" value="Reply" />
                   </a>
                   
                   <a href="<?=base_url()?>work/work_details/<?=$pitch_details['id']?>">
