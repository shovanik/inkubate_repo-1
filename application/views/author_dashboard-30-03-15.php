...
function update_profile()
{
    ...
    <div class="content_part">
      <div class="mid_content index_sec mid_content_new">
        <div class="top_welcome_section index_for_mob">
          ...
          if($mailinvite != ""){ ?>
          	<div class="invite_msg"><?php //echo $this->session->userdata('invite_mail');?>
          ...
          <ul>
              ...
              <li><a href="javascript:void(0);" class="pink_icon hidetext3 tip_trigger1" id="notify"><span class="tip1" id="msg_id">Click to show recent messages</span></a><span class="pink" id="cnt"><?php echo count($user_notification_count)?></span></li>
              <li><a href="javascript:void(0);" class="orange_icon hidetext5 tip_trigger2" id="pitchit"><span class="tip2" id="pub_id">Click to view PitchIt! messages</span></a><span class="orange" id="pitcnt"><?php echo $pitchit_count['count'];?></span></li>
            </ul>
            ...
            if(!empty($pitchit_details_limit))
        {
          ...
          <?php if(!empty($user_photo['filename'])) {?>
            ...
            <p style="font-size:12px;">Welcome<span class="prsn_con">
            ...
            <span class="tp_span9"><?php echo $fullname;?></span>
              ...
              <span class="prsn_con" style="padding-left:0;}">Profile is 100% complete</span>
              </p>
              <div class="clear"></div>
               <button class="upld_butt3" style="background-color:#2e75b6; margin-top:-27px; margin-left:34%;" onclick="update_profile()">Update Profile</button>
              <div class="clear"></div>
 ...
 <div class="clear"></div>
                  ...
                  if(!empty($single_user))
                  {
                   ...
                   <a class="tooltips" href="javascript:void(0)" > 
                    <?php $full_name5 = $single_user['name_first'].' '.$single_user['name_middle'].' '.$single_user['name_last'];
                       ...
                       if(strlen($full_name5) > 9)
                        {
                           echo substr($full_name5,0,9).'..';
                        }
                        else
                        {
                            echo $full_name5;
	...
	$(document).keyup(function(event){
     ...
     CKEDITOR.replace( 'editor2_<?php echo $pitch_details['id']?>', {
    ...
    <div style=" width:100%; background:#000; padding:20px 0;">
		   ...
		   <div class="top_compose">
                                       ...
                                       ?>
                                        ...
                                        <div class="comm_tarea">
                                            <textarea class="ckeditor" cols="80" name="desc"  id="editor2_<?php echo $pitch_details['id']?>" > </textarea>
                                        </div>
     ...
     <div class="clear"></div>
                  ...
                  if(strlen($pitch_details['pitchit']) > 30)
                      {
                      ?>  
                  <span id="pit_work_vw22_<?=$pitch_details['pit_id']?>" style="cursor: pointer;">
          ...
          ?>        
                ...
                $(document).ready(function () {
                   ...
                   $('#pit_work_vw22_'+<?=$pitch_details['pit_id']?>).click(function () {
                        
                            $('.pit_work_dialog').hide();
                            
                            $("#pit_work_dialog_vw22_"+<?=$pitch_details['pit_id']?>).dialog({
                            ...
                            $("#pit_work_dialog_vw22_"+<?=$pitch_details['pit_id']?>).show();
                            //$('.pit_work_dialog').addClass('pit_work_dialog_pos_mid');
                        
                    });
                    
                    
                     $('#cancl_pit_vw_'+<?=$pitch_details['pit_id']?>).click(function () {
                       
                            //$(".pit_work_dialog_vw22_"+<?=$pitch_details['pit_id']?>).dialog('close');
                            $("#pit_work_dialog_vw22_"+<?=$pitch_details['pit_id']?>).hide();
                  ...
                  <div id="pit_work_dialog_vw22_<?=$pitch_details['pit_id']?>" style="display: none;" class="pit_work_dialog">
                  
                  
                    <p><strong> PitchIt!</strong></p>
                    <p><?=$pitch_details['pitchit'];?></p>
                    <a href="javascript:void(0);" id="cancl_pit_vw_<?=$pitch_details['pit_id']?>" class="col3">Cancel</a>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_new">
              ...
              <?php 
                ...
                <tr>
                  ...
                  <?php 
                  if(strlen($pitch_details['pitchit']) > 20)
                  {
                    ?>
                    
                    <span id="pit_work_vw88_<?=$pitch_details['pit_id']?>" style="cursor: pointer;">
                    <?=substr($pitch_details['pitchit'],0,20).'..'?>
                ...
                $(document).ready(function () {
                  ...
                  <div id="pit_work_dialog_vw88_<?=$pitch_details['pit_id']?>" style="display: none;" class="pit_work_dialog">
                    ...
                    <p><strong> PitchIt!</strong></p>
                    <p><?=$pitch_details['pitchit'];?></p>
                    <a href="javascript:void(0);" id="cancl_pit_vw88_<?=$pitch_details['pit_id']?>" class="col3">Cancel</a>
                    <!--<a href="###" onclick="click_edit_pit()">Edit</a><a href="#">Save</a><a href="#">Cancel</a><a href="#">PitchIt!</a>-->
                  </div>
 ...
 <div class="clear"></div>
                ...
                $(document).ready(function () {
                   ...
                   $('#pit_work_'+<?=$pitch_details['id']?>).click(function () {
                          ...
                          $('.pit_work_dialog').hide();
                            ...
                            $("#pit_work_dialog_"+<?=$pitch_details['id']?>).show();
                     ...
                     $('#cancl_pit_'+<?=$pitch_details['id']?>).click(function () {
                            ...
                            $("#pit_work_dialog_"+<?=$pitch_details['id']?>).hide();
                  ...
                  <div id="pit_work_dialog_<?=$pitch_details['id']?>" style="display: none;" class="pit_work_dialog">
           ...
           if(strlen($pitch_details['pitchit']) > 16)
                ...
                $(document).ready(function () {
                  ...
                  <div id="pit_work_dialog_lat_first_all_<?=$pitch_details['id']?>" style="display: none;" class="pit_work_dialog">
                    <h1><?=$total_response_recent['subject']?>
                    </h1>
                    <p>An AEP member has sent a message to you <?=$total_response_recent['body']?></p>
    ...
    CKEDITOR.replace( 'editor3_<?php echo $pitch_details['id']?>', {
            removeButtons: 'Source',
            // The rest of options...
        }); 
    ...
    <div style=" width:100%; background:#000; padding:20px 0;">
		   ...
		   <div class="top_compose">
                                       ...
                                       ?>
                                        ...
                                        <div class="comm_tarea">
                                            <textarea class="ckeditor" cols="80" name="desc"  id="editor3_<?php echo $pitch_details['id']?>" > </textarea>
                                        </div>
                                            <div class="clear"></div><br />
          ...
          ?>        
                ...
                $(document).ready(function () {
                  ...
                  <div id="pit_work_dialog_vw223_<?=$pitch_details['pit_id']?>" style="display: none;" class="pit_work_dialog">
                    ...
                    <p><strong> PitchIt!</strong></p>
                    <p><?=$pitch_details['pitchit'];?></p>
                    <a href="javascript:void(0);" id="cancl_pit_vw223_<?=$pitch_details['pit_id']?>" class="col3">Cancel</a>
                    <!--<a href="###" onclick="click_edit_pit()">Edit</a><a href="#">Save</a><a href="#">Cancel</a><a href="#">PitchIt!</a>-->
                  </div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_new">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a class="tooltips" href="javascript:void(0)" >
                  <?php 
                  if(strlen($total_viw['title']) > 12)
                  {
                    echo substr($total_viw['title'],0,12).'...';
                  }
                  else
                  {
              ...
              <tbody id="purchase_tbody">
                <tr>
                  ...
                  <h3>Please Review and Complete these Fields to Purchase PitchIts!</h3>
                            ...
                            <td><select name="menu" id="country" name="country">
                            <option>USA</option>
                            ...
                            <input name="button" type="button" value="Checkout" class="green_but flo_right" onclick="getPurchaseDiv();" /></td>
                            </tr>
                            </table>
            ...
            <div id="tabs_dem"> 
              <div class="box_section box_section_mar_right30">
                ...
                <div class="myclick_para"><div class="myclick_span"><?=$user_search_count['count']?></div>
                  ...
                  <span class="tp_span">Your titles have been searched<?=$user_search_count['count']?> times by various agents, editors and publishers</span>
 <div class="clear"></div>
                </a>
              ...
              <div class="box_section box_section_mar_right30">
                ...
                <div class="myclick_para" ><div class="myclick_span" ><?=$user_download_count['count']?></div>
                 Title Downloads</div>
                  ...
                  <span class="tp_span">Your titles have been downloaded <?=$user_download_count['count']?> times by various agents, editors and publishers</span>
 <div class="clear"></div>
                </a>
              ...
              <div class="box_section">
                ...
                <div class="myclick_para"><div class="myclick_span" ><?=$user_bookshelf_count['count']?></div>
                  ...
                  <span class="tp_span">Your titles have been placed on bookshelves <?=$user_bookshelf_count['count']?> times by various agents, editors and publishers</span>
 <div class="clear"></div>
                </a>
...
<script type="text/javascript">
  ...
  <tr>
    <td>
    <a class="tooltips" href="javascript:void(0);">
    <div><?=(strlen($total_searcher['title']) > 20 ? substr($total_searcher['title'],0,20).'...' : $total_searcher['title']);?></div>
...
<?php } ?> 
  ...
  <tr>
    ...
    <a class="tooltips" href="javascript:void(0);">
    <div><?=(strlen($total_viewer['title']) > 20 ? substr($total_viewer['title'],0,20).'...' : $total_viewer['title']);?></div>
...
<?php } ?> 
  ...
  <tr>
    <td>
    <a class="tooltips" href="javascript:void(0);">
    <div><?=(strlen($total_downloader['title']) > 20 ? substr($total_downloader['title'],0,20).'...' : $total_downloader['title']);?></div>
...
<?php } ?>
  ...
  <tr>
    ...
    <a class="tooltips" href="javascript:void(0);">
    <div><?=(strlen($total_bookshelved_user['title']) > 20 ? substr($total_bookshelved_user['title'],0,20).'...' : $total_bookshelved_user['title']);?></div>
...
<?php } ?>
        ...
        <div class="pitchits_section_right work_section work_section_mob pitchits_section_new5">
         ...
         <div class="pit_work_dialog_lat_first_mywork_pit popup_chng" style="display: none;" id="pit_work_dialog">
                  ...
                  <header>
					<h3 style="padding-left:40% !important;">Pitchit Content</h3>
				</header>
               <div class="clear"></div>
...
onKeyUp="limitText(this.form.desc,this.form.cout,140);"></textarea>
     ...
     <select data-placeholder="Choose a publisher..." class="chosen-select input_box" multiple="multiple" name="cate_gory_hid[]" id="cate_gory_hid" >
          ...
          <?php } ?>
            ...
            <input name="send" type="button" value="Send" class="btn_viw1" style="margin-top: 15px;" onclick="create_pitchit()" />
            <input name="save" type="button" value="Save" class="btn_viw1" style="margin-top: 15px;" onclick="save_pitchit()"/>
            <input name="save" type="button" value="Close" class="btn_viw1" style="margin-top: 15px;" id="cancl_work_pit" />
             </form>                     
               ...
               <!-- <a href="javascript:void(0);" id="cancl_work_pit">Close</a>--> */?>
                ...
                <!--<h4><?php /*if(strlen($details['title']) > 18) { ?><?=substr($details['title'],0,18)?>... <?php }else{ ?><?=$details['title']?><?php } */?></h4>-->
                ...
                <?php } else { ?>
                <p class="cvrsec_img"><?php /*?><img src="<?=base_url()?>images/img_default_cover_mywork.png"/><?php */?>
                <?=$details['title']?>
                </p>
                <?php } ?>
                </div>
                ...
                Format: <?=$details['work_type_name']?><br>
                Genre: <?php if(!empty($user_category_details))
                     {
                     $cat_name = '';
                ...
                <div class="btn_sec">
                <span><a href="javascript:;" class="blue_but1 view_open" onclick="openDialog(<?php echo $details['id'];?>)">VIEW</a></span>
                
                <?php if($details['is_pitchited'] == '1') {?>
                
                <span class="p_icon"><img src="<?=base_url()?>images/icon033.png" alt="" /></span>
                
                <?php } else {?>
               
                <span><a href="javascript:void(0);" class="pitchit_pop_icon1" onclick="openDialogPitchit(<?php echo $details['id'];?>)"><img src="<?php echo base_url()?>/images/icon_p.png" id="img_grn_<?php echo $details['id'];?>" /></a></span> 
               
                <?php } ?>
                
                <span><a href="<?=base_url()?>work/editWork/<?=$details['id']?>" class="green_bg1">EDIT</a></span>
