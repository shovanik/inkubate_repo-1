  ...
  <div class="cd-popup-container_reply">
    ...
    <a href="" class="cd-popup-close img-replace">Close</a>
     ...
     <div class="clear"></div>
            ...
            <?php if($view_more > 0){ ?><a href="javascript:;" onclick="getPitchit(<?php echo $page+1;?>, 'tab4', 'pitchit')" class="blue_but floright_martop">VIEW MORE</a><?php }else{?> <!--<a href="javascript:;" class="blue_but floright_martop">VIEW OLDER</a>--> <?php } ?>

            <?php if($offset == "0"){?>&nbsp;<?php }else{ ?> <a href="javascript:;" class="green_but floright_martop" onclick="getPitchit(<?php echo $page-1;?>, 'tab4', 'pitchit')">PREVIOUS</a> <?php } ?> 
             </div>
            <?php } } ?>