...
.blue_back {height: 120px !important; color:#000; padding: 10px 60px 0 35px !important; width: 743px ;line-height: 18px;}
...
<?php } ?>
        ...
        <div class="pitchits_section_right work_section work_section_mob pitchits_section_new5">
         ...
         <div class="pit_work_dialog_lat_first_mywork popup_chng" style="display: none;" id="pit_work_dialog">
          ...
          <?php } ?>
            ...
            <input name="save" type="button" value="Close" class="btn_viw1" style="margin-top: 15px;" id="cancl_work_pit" />
               ...
               <!-- <a href="javascript:void(0);" id="cancl_work_pit">Close</a>--> */?>
                ...
                <span><a href="javascript:void(0);" class="green_bg1" onclick="">EDIT</a></span>
