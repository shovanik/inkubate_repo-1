                ...
                <div class="mid_content mid_content_inner">
                  ...
                  <?=$this->load->view('template/mail_sidebar.php');?>
                    ...
                    <div class="mid_content_inner_right">
                         ...
                         <h1>Pitchit Inbox (<?= $pitchit_count;?>)</h1>
                               ...
                               <div class="drop_menu_section">
                                    ...
                                    <form action="" method="post">
                                        <div class="drop_cont">
                                            <ul class="dropdown trigger">
                                                ...
                                                <li class="dropdown-list list" id="mark_msg">Mark</li>
                                                <li class="dropdown-list list" id="unmark_msg">Unmark</li>
                                            </ul>
                                        </div>
                                    ...
                                    foreach($pitchit_details as $key=>$fdetails) {
                                    ?>
