...
if(!empty($reply_mail_details)){
 ...
 <p class="right_date"><span><?php echo date('d F Y',strtotime($reply_data['msg_created'])) ?> </span> at <strong><?php echo date('h:i A',strtotime($reply_data['msg_created']))?></strong></p>
...
<p class="right_date"><span><?php echo date('d F Y',strtotime($single_mail_details['msg_created']))?> </span> at <strong><?php echo date('H:i A',strtotime($single_mail_details['msg_created']))?></strong></p>
<div class="drop_menu_section_left">
<div class="prof">
    <div class="drop_menu_section_left_text">
