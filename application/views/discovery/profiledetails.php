...
function limitText(limitField, limitCount, limitNum) {
    ...
    <div class="content_part">
      ...
      <div class="mid_content">
        	...
        	<img src="<?=base_url()?>images/icon_p.png" alt="" /><span>Profiles</span> 
            <div class="clear"></div>
        </div>
    ...
    <thead>                                                                                                                          
      <tr>
         ...
         <th width="44%" align="center">View Date</th>
            ...
            <?php 
               ...
               ?>
                ...
                <tr class="pitchits_table_content">
                    ...
                    <td align="center">
                    <?php 
                      if($pitch_details['user_type'] == '1') 
                        { 
                        echo 'Author'; 
                        }
                      if($pitch_details['user_type'] == '2') 
                        { 
                        echo 'Publisher'; 
                        }  
                    ?></td>
                    <td align="center"><?php echo date('m/d/Y',strtotime($pitch_details['view_date']))?></td>
               ...
               <?php $i++; } }  else { ?>
                ...
                <td width="44%" align="center"><p>Sorry! There are no Profile Viewer.</p></td>
