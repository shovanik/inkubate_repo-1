...
function ajaxDiscovery_global_search(page,str)
{
    //console.log('hi');
	...
	if(format == 1)
 	{
 		...
 		$.ajax({
		   ...
		   type     : 'POST',
		   data     : { 'page': page, 'str': str, format:format_str, type:type},
		   success  : function(resp){
		    //alert(resp);
		        if(resp != '0'){
		            $("#tab1").html(resp);
 	...
 	else if(types == 1)
 	{
 		...
 		$.ajax({
		   url      : '<?=base_url()?>'+'discovery/ajax_discovery_global_search',
		   type     : 'POST',
		   data     : { 'page': page,  'str': str, types:types_str,type:type },
		   success  : function(resp){
		    //alert(resp);
		        if(resp != '0'){
		            $("#tab1").html(resp);
 	...
 	else if(genre == 1)
 	{
 		...
 		$.ajax({
		   url      : '<?=base_url()?>'+'discovery/ajax_discovery_global_search',
		   type     : 'POST',
		   data     : { 'page': page,  'str': str, genre:genre_str,type:type },
		   success  : function(resp){
		    //alert(resp);
		        if(resp != '0'){
		            $("#tab1").html(resp);
 	...
 	else if(multiple == 1)
 	{
        ...
        //alert(types_str);
 		...
 		$.ajax({
		   url      : '<?=base_url()?>'+'discovery/ajax_discovery_global_search',
		   type     : 'POST',
		   data     : { 'page': page,  'str': str,  genre:genre_str, types:types_str, format:format_str, type:type, subtype:subtype, searchCriteria:searchCriteria },
		   success  : function(resp){
		    //alert(resp);
		        if(resp != '0'){
		            $("#tab1").html(resp);
...
function openDialog_global_serch(id,str)
 {
 	//alert(str);
 	$.ajax({
       url      : '<?=base_url()?>'+'bookshelves/show_book_detail',
