 ...
 <div class="clear"></div> -->
             ...
             <?php } ?>
                   ...
                   <td align="center">
                    ...
                    <a class="tooltips" href="javascript:void(0);" onclick="openDialog_global_serch(<?php echo $details['id'];?>,'<?php echo strip_tags($keyword);?>','<?php echo $status;?>')">
...
<!--                  <td align="center"><span style="cursor: pointer;" onclick="openDialog(<?php echo $details['id'];?>)"><?php if(strlen($details['title']) > 15){ echo substr($details['title'],0,15)."..."; }else{ echo $details['title']; }?></span></td>-->
           ...
           <div class="button_right"><?php if($offset == "0"){?>&nbsp;<?php }else{ ?> <a href="javascript:;" class="green_but" onclick="ajaxDiscovery_global_search(<?php echo $page-1;?>,'<?php echo $keyword;?>','<?php echo $status;?>')">PREVIOUS</a> <?php } ?> 
           <?php if($total_rows > $offset+5){ ?><a href="javascript:;" onclick="ajaxDiscovery_global_search(<?php echo $page+1;?>,'<?php echo $keyword;?>','<?php echo $status;?>')" class="blue_but">VIEW MORE</a><?php }else{?>&nbsp;<?php } ?></div>
