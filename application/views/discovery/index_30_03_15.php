...
function selectMultiple(type)
{
	...
	$("#subtype").val("");
	$("#searchCriteria").val("");
	$("#replace_plus_two").html('<img src="'+base_url+'images/arrow_down.png" alt="" class="right_flo"  onclick="selectMultiple(\'format\')" style="cursor:pointer; margin-top: 7px;">');
	$("#replace_plus_four").html('<img src="'+base_url+'images/arrow_down.png" alt="" class="right_flo"  onclick="selectMultiple(\'types\')" style="cursor:pointer; margin-top: 7px;">');
	$("#replace_plus_five").html('<img src="'+base_url+'images/arrow_down.png" alt="" class="right_flo"  onclick="selectMultiple(\'genre\')" style="cursor:pointer; margin-top: 7px;">');
	$("#replace_plus_six").html('<img src="'+base_url+'images/arrow_down.png" alt="" class="right_flo"  onclick="selectMultiple(\'multiple\')" style="cursor:pointer; margin-top: 7px;">');
	//alert(format);
	if(type == "format")
	{
            format = 1;
            ...
            if($("#dropdown_two").css("display") == 'none'){
                $("#replace_plus_two img").attr('src', base_url+'images/arrow_down.png');
            }else{
                $("#replace_plus_two img").attr('src', base_url+'images/arrow_up.png');
            }
        }
	if(type == "genre")
	{
            ...
            if($("#dropdown_five").css("display") == 'none'){
                $("#replace_plus_five img").attr('src', base_url+'images/arrow_down.png');
            }else{
                $("#replace_plus_five img").attr('src', base_url+'images/arrow_up.png');
            }
	}
	if(type == "multiple")
	{
            ...
            if($("#dropdown_six").css("display") == 'none'){
                $("#replace_plus_six img").attr('src', base_url+'images/arrow_down.png');
            }else{
                $("#replace_plus_six img").attr('src', base_url+'images/arrow_up.png');
            }
	}
	if(type == "types")
	{
            ...
            if($("#dropdown_four").css("display") == 'none'){
                $("#replace_plus_four img").attr('src', base_url+'images/arrow_down.png');
            }else{
                $("#replace_plus_four img").attr('src', base_url+'images/arrow_up.png');
            }
	}
	$(".multiple").removeClass("blue_select");
	$(".format").removeClass("blue_select");
...
function openDialog(id)
 ...
 function savetitle()
 {
    ...
    $.ajax({
               ...
               if(resp == 1)
                   {
                   $("#title_saved").html('<font color="green">Successfully saved the title</font>');
                   }
               else
                   {
                    $("#title_saved").html('<font color="green">Already saved this title</font>');
                   }    
...
<li id="current" class="li_pad" onclick="selectMultiple('types')"><img src="<?=base_url()?>images/filter_icon02.png" alt="" /> Filter by Type <span id="replace_plus_four"><img src="<?=base_url()?>images/arrow_down.png" alt="" class="right_flo" style="cursor:pointer; margin-top: 7px;" /></span>
...
<li id="current" class="li_pad" onclick="selectMultiple('format')"><img src="<?=base_url()?>images/filter_icon01.png" alt="" /> Filter by Format <span id="replace_plus_two"><img src="<?=base_url()?>images/arrow_down.png" alt="" class="right_flo"  style="cursor:pointer; margin-top: 7px;"/></span>
...
<li id="current" class="li_pad" onclick="selectMultiple('genre')"><img src="<?=base_url()?>images/filter_icon03.png" alt=""  /> Filter by Genre <span id="replace_plus_five"><img src="<?=base_url()?>images/arrow_down.png" alt="" class="right_flo"  style="cursor:pointer; margin-top: 7px;" /></span>
...
<li id="current" class="li_pad" onclick="selectMultiple('multiple')"><img src="<?=base_url()?>images/filter_icon04.png" alt="" /> Advanced Search <span id="replace_plus_six"><img src="<?=base_url()?>images/arrow_down.png" alt="" class="right_flo"  style="cursor:pointer; margin-top: 7px;" /></span>
...
<li><a href="javascript:;" name="tab5" onclick="savedSearchesCount()"><img src="<?=base_url()?>images/circle_edit.png" alt="" /> Saved Searches</a></li>
          ...
          <div class="pitchits_section_right" id="content">
            ...
            <?php if(strlen($details['name_first'].' '.$details['name_middle'].' '.$details['name_last']) > 10) {?>
             ...
             <a class="tooltips" href="javascript:void(0)">
                  ...
                  <label><?php echo substr($details['name_first'].' '.$details['name_middle'].' '.$details['name_last'],0,10)."..."?></label> 
 ...
 <div class="clear"></div>
             ...
             <?php } ?> 
                  ...
                  <td align="center">
                  <?php 
                  if(strlen($details['category_name']) > 11)
                  {
                    echo substr($details['category_name'],0,11).'..';
                  }
                  else
                  {
                    echo $details['category_name'];
                  }
                  ?>
                  </td>
                </tr>
...
<span id="download"></span> 
                    ...
                    <a class="green_but" id="savetitle" style="cursor: pointer;" onclick="savetitle()">Save Title</a>
