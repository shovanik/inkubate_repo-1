...
function selectMultiple(type)
{
	...
	$("#subtype").val("");
	$("#searchCriteria").val("");
	$("#replace_plus_two").html('<img src="'+base_url+'images/plus.png" alt="" class="right_flo"  onclick="selectMultiple(\'format\')" style="cursor:pointer">');
	$("#replace_plus_four").html('<img src="'+base_url+'images/plus.png" alt="" class="right_flo"  onclick="selectMultiple(\'types\')" style="cursor:pointer">');
	$("#replace_plus_five").html('<img src="'+base_url+'images/plus.png" alt="" class="right_flo"  onclick="selectMultiple(\'genre\')" style="cursor:pointer">');
	$("#replace_plus_six").html('<img src="'+base_url+'images/plus.png" alt="" class="right_flo"  onclick="selectMultiple(\'multiple\')" style="cursor:pointer">');
	//alert(format);
	if(type == "format")
	{
		...
		format = 1;
		$("#dropdown_two").show();
		$("#replace_plus_two").html('<img src="'+base_url+'images/minus.png" alt="" class="right_flo"  onclick="removeMultiple(\'format\')" style="cursor:pointer">');
	}
	if(type == "genre")
	{
		genre = 1;
		$("#dropdown_five").show();
		$("#replace_plus_five").html('<img src="'+base_url+'images/minus.png" alt="" class="right_flo"  onclick="removeMultiple(\'genre\')" style="cursor:pointer">');
	}
	if(type == "multiple")
	{
		multiple = 1;
		$("#dropdown_six").show();
		$("#replace_plus_six").html('<img src="'+base_url+'images/minus.png" alt="" class="right_flo"  onclick="removeMultiple(\'multiple\')" style="cursor:pointer">');
	}
	if(type == "types")
	{
		types = 1;
		$("#dropdown_four").show();
		$("#replace_plus_four").html('<img src="'+base_url+'images/minus.png" alt="" class="right_flo"  onclick="removeMultiple(\'types\')" style="cursor:pointer">');
	}
	$(".multiple").removeClass("blue_select");
	$(".format").removeClass("blue_select");
	$(".genre").removeClass("blue_select");
...
function openDialog(id)
 ...
 $('#searchShow').keyup(function (event) {
 	...
 	if(keycode == 13) {
        ...
        <input name="searchShow" id="searchShow" type="text" value="" placeholder="Search..." >
...
<li id="current" class="li_pad"><img src="<?=base_url()?>images/filter_icon02.png" alt="" /> Filter by Type <span id="replace_plus_four"><img src="<?=base_url()?>images/plus.png" alt="" class="right_flo"  onclick="selectMultiple('types')" style="cursor:pointer" /></span>
...
<li id="current" class="li_pad"><img src="<?=base_url()?>images/filter_icon01.png" alt="" /> Filter by Format <span id="replace_plus_two"><img src="<?=base_url()?>images/plus.png" alt="" class="right_flo"  onclick="selectMultiple('format')" style="cursor:pointer"/></span>
...
<li id="current" class="li_pad"><img src="<?=base_url()?>images/filter_icon03.png" alt=""  /> Filter by Genre <span id="replace_plus_five"><img src="<?=base_url()?>images/plus.png" alt="" class="right_flo"  onclick="selectMultiple('genre')" style="cursor:pointer" /></span>
...
<li id="current" class="li_pad"><img src="<?=base_url()?>images/filter_icon04.png" alt="" /> Advanced Search <span id="replace_plus_six"><img src="<?=base_url()?>images/plus.png" alt="" class="right_flo"  onclick="selectMultiple('multiple')" style="cursor:pointer" /></span>
