...
function limitText(limitField, limitCount, limitNum) {
    ...
    <div class="content_part">
      ...
      <div class="mid_content">
        	...
        	<img src="<?=base_url()?>images/icon_p.png" alt="" /><span>Downloaded Work File</span> 
            <div class="clear"></div>
        </div>
    ...
    <thead>                                                                                                                          
      <tr>
         ...
         <th width="20%" align="center">Download File</th>
         <th width="20%" align="center">Downloaded Date</th>
            ...
            <?php 
               ...
               ?>
                ...
                <tr class="pitchits_table_content">
                    ...
                    <td align="center"><?php echo $pitch_details['file'];?></td>
                    <td align="center"><?php echo date('m/d/Y',strtotime($pitch_details['created_at']))?></td>
