...
function removeMultiple(type)
{
	...
	if(type == "format")
	{
		...
		$("#dropdown_two").hide();
		$("#replace_plus_two").html('<img src="'+base_url+'images/arrow_down.png" alt="" class="right_flo"  onclick="selectMultiple(\'format\')" style="cursor:pointer">');
		$(".format").removeClass("blue_select");
		arr_format = new Array();
	}
	if(type == "genre")
	{
		...
		$("#dropdown_five").hide();
		$("#replace_plus_five").html('<img src="'+base_url+'images/arrow_down.png" alt="" class="right_flo"  onclick="selectMultiple(\'genre\')" style="cursor:pointer">');
		arr_genre = new Array();
		$(".genre").removeClass("blue_select");
	}
	if(type == "multiple")
	{
		...
		multiple = 0;
		$("#dropdown_six").hide();
		$("#replace_plus_six").html('<img src="'+base_url+'images/arrow_down.png" alt="" class="right_flo"  onclick="selectMultiple(\'multiple\')" style="cursor:pointer">');
		$(".multiple").removeClass("blue_select");
		arr_format = new Array();
		arr_types = new Array();
		arr_genre = new Array();
	...
	if(type == "types")
	{
		types = 0;
		$("#dropdown_four").hide();
		$("#replace_plus_four").html('<img src="'+base_url+'images/arrow_down.png" alt="" class="right_flo"  onclick="selectMultiple(\'types\')" style="cursor:pointer">');
		arr_types = new Array();
		$(".types").removeClass("blue_select");
	}
}
