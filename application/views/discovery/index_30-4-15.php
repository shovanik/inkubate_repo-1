...
<li><a href="javascript:void(0);" name="tab5" onclick="savedSearchesCount()"><img src="<?=base_url()?>images/circle_edit.png" alt="" /> Saved Searches</a></li>
          ...
          <div class="pitchits_section_right" id="content">
		    ...
		    <?php if($details['gender'] == "1"){?>
		    	<img src="<?=base_url()?>images/man_image.png" style="border: 1px solid #444; height:30px"/>
		    <?php }else{?>
		    	<img src="<?=base_url()?>images/woman_image.png" style="border: 1px solid #444; height:30px"/>
		    <?php }?>
		    <?php } ?>
             ...
             <?php } ?> 
                ...
                <td align="center">
                 <a class="tooltips" onclick="openDialog('<?php echo $details['id'];?>')">
                     ...
                     <label style="cursor: pointer;" title="<?php echo $details['title'];?>"><?php echo substr($details['title'],0,15)."...";?></label> 
...
<!--                  <td align="center" ><span style="cursor: pointer;"  onclick="openDialog(<?php echo $details['id'];?>)"><?php if(strlen($details['title']) > 15){ echo substr($details['title'],0,15)."..."; }else{ echo $details['title']; }?></span></td>-->
                ...
                <td align="center">
                    <a class="tooltips" href="javascript:void(0);">
                        ...
                        <label style="cursor: pointer;" title="<?php echo $details['category_name'];?>"><?php echo substr($details['category_name'],0,11)."...";?></label> 
...
<span id="download"></span> 
 ...
 <!-------------------------End Popup--------------------------------------------->     
           ...
           <div class="button_right"><?php if($offset == "0"){?>&nbsp;<?php }else{ ?> <a href="javascript:void(0);" class="green_but" onclick="ajaxSavedSearches(<?php echo $page_ss-1;?>)">PREVIOUS</a> <?php } ?> <?php if($total_rows_ss > $offset+5){ ?><a href="javascript:void(0);" onclick="ajaxSavedSearches(<?php echo $page_ss+1;?>)" class="blue_but">VIEW MORE</a><?php }else{?> <a href="javascript:void(0);" class="blue_but">VIEW MORE</a> <?php } ?></div>
